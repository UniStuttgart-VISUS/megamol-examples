...
mmCreateCall("FlagCallRead_GL","::ParallelCoordinatesRenderer2D_1::readFlags","::UniFlagStorageGL_1::readFlags")
mmCreateCall("FlagCallWrite_GL","::ParallelCoordinatesRenderer2D_1::writeFlags","::UniFlagStorageGL_1::writeFlags")
