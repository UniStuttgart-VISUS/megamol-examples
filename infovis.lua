...
mmCreateModule("SplitViewGL","::SplitViewGL_1") --confPos={X=304,Y=48} 
mmCreateModule("View2DGL","::View2DGL_1") --confPos={X=576,Y=48} 
mmCreateModule("View2DGL","::View2DGL_2") --confPos={X=574,Y=143} 
...
mmCreateCall("CallRenderViewGL","::gui::renderview","::SplitViewGL_1::render")
...
mmCreateCall("CallRender2D","::View2DGL_1::rendering","::ScatterplotMatrixRenderer2D_1::rendering")
mmCreateCall("CallRender2D","::View2DGL_2::rendering","::ParallelCoordinatesRenderer2D_1::rendering")
