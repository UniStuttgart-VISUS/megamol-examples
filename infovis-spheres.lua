...
mmCreateCall("CallGetTransferFunctionGL","::SphereRenderer_1::gettransferfunction","::TransferFunction_1::gettransferfunction")
...
mmSetParamValue("::TableToParticles_1::color",[=[white]=])
mmSetParamValue("::TableToParticles_1::colormode",[=[global RGB]=])
